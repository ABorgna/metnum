...
# def generar_grafos(min_cant_nodos, max_cant_nodos, step_cant_nodos, p_densidad, cant_intentos, output_dir="gen"):
#     print("Generando grafos en directorio: '{}/'".format(output_dir))
#     print("--> params: {} <= n < {}, step_n:{}, p_densidad: {}, #intentos={}".format(min_cant_nodos, max_cant_nodos, step_cant_nodos, p_densidad, cant_intentos))
...
#     for n in range(min_cant_nodos, max_cant_nodos, step_cant_nodos):
#         print("Generando ahora random-{}-nodos (x{})".format(n, cant_intentos))

#         for nro_prueba in range(0, cant_intentos):
#             g = generar_grafo_random(n, p_densidad)
