...
def generar_grafos(t_args, t_files):
    ...
    print("--> params: {} <= n < {}, step_n:{}, p_densidad={}, #intentos={}".format(t_args.min_cant_nodos, t_args.max_cant_nodos, t_args.step_cant_nodos, t_args.p_densidad, t_args.cant_intentos))
    ...
    for n in range(t_args.min_cant_nodos, t_args.max_cant_nodos, t_args.step_cant_nodos):
        ...
        for nro_prueba in range(0, t_args.cant_intentos):
            g = generar_grafo_random_de_densidad(n, t_args.p_densidad)
...
def escribir_resultados_en_archivo(input_name, cant_nodos, nro_intento, tiempo_ns, t_args, t_file):
    resultado.write("{},{},{},{},{},{},{},{},{},{}\n".format(input_name, t_args.p, t_args.p_densidad, t_args.min_cant_nodos, t_args.max_cant_nodos, t_args.step_cant_nodos, cant_nodos, nro_intento, t_args.cant_intentos, tiempo_ns))
    print("{},{},{},{},{},{},{},{},{},{}".format(input_name, t_args.p, t_args.p_densidad, t_args.min_cant_nodos, t_args.max_cant_nodos, t_args.step_cant_nodos, cant_nodos, nro_intento, t_args.cant_intentos, tiempo_ns))
...
class TestArgs:
    def __init__(self, p, p_densidad, cant_intentos, min_cant_nodos, max_cant_nodos, step_cant_nodos):
        self.p_densidad = p_densidad
        self.p = p
...
# Parametros
t_files = TestFiles("gen/", "resultados/", "random-var-n-m-ajustado-data.csv")
t_args = TestArgs(0.5, 0.3, 20, 20, 1000, 10)
...
resultado.write("nombre,p,p_densidad,min_cant_nodos,max_cant_nodos,step_nodos,cant_nodos,nro_intento,cant_intentos,tiempo_ns\n") # header
